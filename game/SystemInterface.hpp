...
public:
	...
	public:
		...
		BaseReflector(Mode mode) : mode(mode) { }
		...
		virtual void buffer(const std::string& type, const std::string& property, double* value, uint32_t count = 1) { }
		virtual void buffer(const std::string& type, const std::string& property, long double* value, uint32_t count = 1) { }
		virtual void buffer(const std::string& type, const std::string& property, uint8_t* value, uint32_t count = 1) { }
		virtual void buffer(const std::string& type, const std::string& property, uint16_t* value, uint32_t count = 1) { }
		virtual void buffer(const std::string& type, const std::string& property, uint32_t* value, uint32_t count = 1) { }
		virtual void buffer(const std::string& type, const std::string& property, uint64_t* value, uint32_t count = 1) { }
		virtual void buffer(const std::string& type, const std::string& property, int8_t* value, uint32_t count = 1) { }
		virtual void buffer(const std::string& type, const std::string& property, int16_t* value, uint32_t count = 1) { }
		virtual void buffer(const std::string& type, const std::string& property, int32_t* value, uint32_t count = 1) { }
		virtual void buffer(const std::string& type, const std::string& property, int64_t* value, uint32_t count = 1) { }
	};

	ComponentInterface(Engine& engine, uint64_t id) : BaseComponent(engine, id) { }

	virtual void serialize(BaseReflector& reflector) { }
};