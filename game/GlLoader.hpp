...
/*
Wrapper around Assimp and STB forloading meshes and images into OpenGL.
Assets are instanced by filename and won't be loaded twice.

Stores OpenGL ids for binding later, and scene hierarchies.
*/
class GlLoader {
public:
	struct MeshContext {
